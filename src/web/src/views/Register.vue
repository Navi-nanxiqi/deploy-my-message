...
const siteConfigData = JSON.parse(JSON.stringify({
...
const slogan = ref(siteConfigData.slogan);
// 设置默认网站标题
                        ...
                        <form class="p-6 md:p-8">
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="grid gap-2">
                                    ...
                                    <Input id="account" v-model="account" type="text" placeholder="" required />
                                </div>
                                <div class="grid gap-2">
                                ...
                                <Button
                                    ...
                                    :disabled="loading" @click.prevent="clickRegister"
                                >
                                    <svg
                                ...
                                <div class="text-center text-sm">
                                    已有账号
                                    <a href="#" class="underline underline-offset-4" @click="handleLogin">
                                        注册
                                    </a>
                                </div>
                            </div>
